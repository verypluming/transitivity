...
if __name__ == '__main__':
    ...
    if not os.path.exists(base_dir):
        print("base_prop directory does not exists!\ntry: generate_prop.sh")
        sys.exit()
    ...
    depth_count = estimate("./base_prop/uniq", proper_names)

    for file in glob.glob("./base_prop/depth*.scheme"):
